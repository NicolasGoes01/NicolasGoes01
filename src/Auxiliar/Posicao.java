...
public class Posicao implements Serializable{
    ...
    public boolean setPosicao(int linha, int coluna){       
        if(linha < 1 || linha > Auxiliar.Consts.FIELD)
            return false;
        linhaAnterior = this.linha;
        this.linha = linha;
        
        if(coluna < 1 || coluna > Auxiliar.Consts.FIELD)
            return false;
    ...
    public boolean samePosition(Posicao obj) {
        return (this.coluna == obj.coluna && this.linha == obj.linha);
    }
}
